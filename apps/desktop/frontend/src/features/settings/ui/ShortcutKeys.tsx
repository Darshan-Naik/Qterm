          ...
          <span className="inline-flex items-center gap-0.75">
            {chordKeys(chord).map((key, j) => (
              <kbd
                key={j}
                className={cn(
                  "inline-flex h-5.5 min-w-5.5 items-center justify-center rounded-md px-1.5 font-sans",
                  "border border-border/80 bg-secondary text-[12px] font-medium leading-none text-foreground/90",
