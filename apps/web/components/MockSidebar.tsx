...
export function MockSidebar() {
  return (
    <aside className="hidden w-[214px] shrink-0 flex-col border-r border-white/6 bg-sidebar sm:flex">
      ...
      <div className="min-h-0 flex-1 px-3 pb-2">
        ...
        <div className="mt-0.5 space-y-0.5">
          ...
          <MockSidebarRow label="claude" agent="claude" open indent needsInput />
